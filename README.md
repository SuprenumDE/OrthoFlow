...
For the OrthoFlow installation, *MSI* files are provided *for Windows*, and if the installation is to be performed on *Linux*, the [*src*](https://github.com/SuprenumDE/OrthoFlow/tree/main/src) and [*include directories*](https://github.com/SuprenumDE/OrthoFlow/tree/main/include) containing the necessary C++ files are provided.
